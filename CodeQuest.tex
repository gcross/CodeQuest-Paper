...
\end{proof}
%@-node:gcross.20100203143542.1282:Lemma: Recombining elements preserves conjugal property for third parties
%@+node:gcross.20100204111315.1302:Lemma: An element can be moved from the extension to the unimprovable set
\begin{lemma}
\label{move-it-over}
...
%@+node:gcross.20100204174120.1285:Statement
\begin{theorem}
...
%@nonl
%@-node:gcross.20100204174120.1285:Statement
%@+node:gcross.20100204174120.1286:Proof
\begin{proof}
...
\begin{description}
%@+others
%@+node:gcross.20100204174120.1284:Case 1
...
%@nonl
%@-node:gcross.20100204174120.1284:Case 1
%@+node:gcross.20100204174120.1287:Case 2
