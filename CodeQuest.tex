...
% 4
\item \label{any product has undetectable error not acting on X} for any product of elements from $\set O$, $o:=\prod_{o'\in \set O} o'$, there exists an undetectable error of weight $\om_{\set S}(o)$ that acts on $o$ but not on any $x\in\set X$;
% 5
